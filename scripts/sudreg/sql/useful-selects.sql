-- Korisni SELECT-ovi za Sudreg (baza: sudreg)
-- Na VPS-u:
--   docker exec -i oriphiel-postgres psql -U oriphiel -d sudreg -f - < useful-selects.sql
...
-- Po snapshotu (koliko firmi po snapshot_id)
...
-- ========== JEDNA FIRMA (detalj) ==========
-- Zamijeni '080000000' svojim MBS-om:
/*
